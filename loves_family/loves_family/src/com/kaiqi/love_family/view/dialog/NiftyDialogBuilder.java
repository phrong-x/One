...
public class NiftyDialogBuilder extends Dialog implements DialogInterface {
	private final String defTextColor="#ffffff";// 字体颜色。

    private final String defDividerColor="#636363";//分隔线颜色。

    private final String defMsgColor="#ffffff";//消息颜色。

   private final String defDialogColor="#cfcfcf";//整体背景色。



    private Effectstype type=null;//选择dialog出来的方式。
    ...
    private void init(Context context) {
        ...
        this.setOnShowListener(new OnShowListener() {
            ...
            public void onShow(DialogInterface dialogInterface) {
                ...
                if(type==null){
                    type=Effectstype.RotateBottom;//设置默认值。
                }
                start(type);
