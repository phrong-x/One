...
//com.android.zxl.pct.view.refresh.PullToRefreshListView
public class PullToRefreshListView extends PullToRefreshAdapterViewBase<ListView> {
    ...
    protected ListView createRefreshableView(Context context, AttributeSet attrs) {
        ...
        final FrameLayout.LayoutParams lp = new FrameLayout.LayoutParams(FrameLayout.LayoutParams.MATCH_PARENT, 0, Gravity.CENTER_HORIZONTAL);
